...
export default defineNuxtConfig({
  ...
  css: ["~/assets/css/terminal.css", "~~/styles/design-tokens.css", "~~/styles/consoles.css", "~~/styles/home-experience.css", "~~/styles/products-experience.css", "~~/styles/tech.css", "~~/styles/asme.css", "~~/styles/px.css", "~~/styles/system.css", "~~/styles/evolve.css", "~~/styles/home-world.css", "~~/styles/ecosystem-world.css", "~~/styles/product-systems.css", "~~/styles/product-scene.css", "~~/styles/tech-dark.css", "~~/styles/architecture-dark.css", "~~/styles/investors-dark.css", "~~/styles/blog-dark.css", "~~/styles/global-font.css", "~~/styles/hero-heading.css", "~~/styles/svara-3d.css", "~~/styles/svara-controls.css", "~~/styles/svara-instrument.css", "~~/styles/divisions-halftone.css", "~~/styles/ecosystem-clarix.css", "~~/styles/investors-synapse.css", "~~/styles/contact-noema.css", "~~/styles/consent.css"],
  vite: {
    resolve: {
      alias: {
