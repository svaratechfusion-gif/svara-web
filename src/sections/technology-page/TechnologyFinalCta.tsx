...
export default function TechnologyFinalCta() {
  return (
    <Section
      size="medium"
    ...
    >
      ...
      <Reveal className="relative mx-auto max-w-2xl">
        ...
        <p className="mx-auto mt-6 max-w-xl text-cinematic-body" style={{ color: "#A9C1E0" }}>
          SVARA&apos;s technology stack empowers enterprises to move beyond
          fragmented systems toward intelligent, autonomous operations.
        </p>
