    ...
    <Section size="large" className="text-center">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <p
          ...
          style={{ color: "#5D8FBE" }}
        >
          Whether you&apos;re exploring enterprise AI transformation,
          strategic partnerships, investment opportunities, or intelligent
          product deployment—SVARA is ready to collaborate.
        </p>
