...
export default function ArchPageHero() {
  return (
    <Section size="large" className="text-center">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <p
          ...
          style={{ color: "#5D8FBE" }}
        >
          SVARA&apos;s AI-native architecture is designed to ingest, process,
          reason, simulate, orchestrate, and operationalize intelligence
