    ...
    <Section size="large" className="text-center">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <p
          ...
          style={{ color: "#5D8FBE" }}
        >
          SVARA operates through specialized technology divisions engineered
          to solve every layer of enterprise transformation—from
          intelligence and simulation to software engineering and growth
          acceleration.
        </p>
