...
export function useIntelligenceWorld() {
  ...
  const activeProductIndex = useState<number | null>("intelligence-world-active-product-index", () => null);
  const selectedProduct = useState<string | null>("intelligence-world-selected-product", () => null);
  const activeIndustryIndex = useState<number | null>("intelligence-world-active-industry-index", () => null);
