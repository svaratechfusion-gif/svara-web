...
// TECHNOLOGY · SECTION 3 — the Features grid, rebuilt: one full-width video card
// ("One Connected Stack.") + three product cards (Vision AI / AI Agents / Digital
// Twin) with numbered headers, check-listed capabilities and a Learn More arrow.
// Dark theme, motion-v fade-ups, SVARA content.
...
const cards = [
  { n: '01', title: 'Vision AI', to: '/products/vision-ai', items: ['Real-time visual intelligence', 'Multi-camera analytics', 'Detection and tracking', 'Edge deployment'] },
  { n: '02', title: 'AI Agents', to: '/products/ai-agents', items: ['Autonomous workflows', 'Enterprise orchestration', 'Human approvals', 'Multi-agent coordination'] },
  { n: '03', title: 'Digital Twin', to: '/products/digital-twin', items: ['Live operational simulation', 'Predictive decision models', 'Scenario planning', 'Real-time synchronization'] },
]
  ...
  <section class="tf tec-dark">
    <div class="tf__inner">
      ...
      >
        ...
        <NuxtLink to="/products" class="tf__hero-body">
          <h3 class="tf__hero-title">One Connected Stack.</h3>
...
.tf__learn {
  ...
  font-size: 14px; font-weight: 700; color: var(--tec-text);
