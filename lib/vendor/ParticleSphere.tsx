// @ts-nocheck — vendored third-party file; do not type-check under our
// strict config. This directive has zero runtime effect (compiled JS is
// identical); the implementation below is unchanged.
/* @jsxRuntime classic */
/* @jsx React.createElement */
/* @jsxFrag React.Fragment */
// ^ force React's JSX for THIS file (the app is Vue; without this the JSX
//   below would compile to Vue VNodes). Comment-only; no code change.
// Particle Sphere — Originkit
// Using component defaults.
//
// VENDORED VERBATIM — this is the original production component, unchanged.
// Do not edit its implementation. It is a React + vanilla-three component;
// it is mounted into the Vue app by app/components/home/ParticleSphere.vue
// via a React root. Excluded from vue-tsc typecheck (see nuxt.config.ts).
